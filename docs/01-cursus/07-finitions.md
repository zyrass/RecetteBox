...
> Méthode recommandée : passer page par page en mode sombre activé, repérer chaque zone restée blanche, lui ajouter sa variante `dark:`. C'est fastidieux mais mécanique. Ne cherche pas à automatiser : la cohérence visuelle se vérifie à l'œil.
...
| Zones blanches résiduelles en sombre | Variantes `dark:` oubliées sur certains éléments | Parcourir chaque page en mode sombre et compléter, à l'œil |
